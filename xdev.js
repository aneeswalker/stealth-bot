...
offline = false
targetpc = '0'
ownerNumber = ["62895379169488@s.whatsapp.net","62895379169488@s.whatsapp.net","62895379169488@s.whatsapp.net","62895379169488@s.whatsapp.net","62895379169488@s.whatsapp.net","62895379169488@s.whatsapp.net"] //GANTI NOMOR LU
fake = 'XDLYY\nSTEALTH - BOT' //GANTI
fake1 = 'STEALTH - BOT' //GANTI
numbernye = '0'
waktu = '-'
alasan = '-'
...
xdev.sendMessage(from,'Nih Kak Creator Stealth - Bot',text,{quoted: hehe})
}
if (button == 'GITHUB') {
console.log('GITHUB')
xdev.sendMessage(from, `*Nih kak github XDLYY*\n*Scnya free kak dan juga free api 🤗*\n*Ingat ! jangan diperjual belikan yah !*\n\nhttps://github.com/Xdlyy`, text, {quoted: dev})
}
if (button == 'REST API') {
console.log('REST API')
xdev.sendMessage(from, `*Nih kak rest api yang digunakan oleh Stealth - Bot Dan juga free*\n\nhttps://xdev-api.herokuapp.com/api\n\n*Gunakan dengan bijak dan jangan spam yah kak 🙏🏻*`, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `Hallo kak ${pushname}`,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/a082de791ef8aff96ec24.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: dev})
}
if (button == 'YOUTUBE') {
console.log('YOUTUBE')
xdev.sendMessage(from, `*Nih kak YouTube XDLYY*\n*Bantu subscribe ya kak subscribe free kok*\n\nhttps://youtube.com/channel/UCCbEbgl_pkNNxhzyMMKcg5Q\n\n*Subscribe ya kak dan nyalain loncengnya*`, text, {quoted: dev})
}
if (budy.startsWith('$')){
if (!dev.key.fromMe && !isOwner) return
qur = budy.slice(2)
exec(qur, (err, stdout) => {
if (err) return reply(`@Xdlyy:~ ${err}`)
if (stdout) {
reply(stdout)
}
})
